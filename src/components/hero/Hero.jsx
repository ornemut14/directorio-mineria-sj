  ...
  return (
    <section className="hero">
      ...
      <div className="hero-content">
        <h1>
          DIRECTORIO ENERGIA Y MINERÍA DE SAN JUAN
        </h1>

        <p>
          Más cerca de los proveedores que necesitás, encontrá, conectá y hacé crecer tu negocio.
        </p>
